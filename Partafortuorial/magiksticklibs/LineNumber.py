...
#     """docstring for LineNumberCanvas."""
#
#     def __init__(self, *args,**kwargs):
#         # super(LineNumberCanvas, self).__init__()
...
#         while True:
#             dline = self.text_widget.index.dlineinfo(temp)
#             if dline is None:
#                 break
#             y = dline[1]
#             x = dline[0]
...
#
# class LineMain:
#     """docstring for LineMain."""
#
#     def __init__(self, text):
#         # super(LineMain, self).__init__()
#         self.text = text
...
#
#         self.linenumbers.bind('&lt;Buttin-l>',self.linenumbers.get_breakpoint_number)
#         return
#
#
