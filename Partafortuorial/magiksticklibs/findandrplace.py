...
#     return fields
#
# class FindReplaceFunc(object):
#     """docstring for FindReplaceFunc."""
#
#     def __init__(self, text):
#         # super(FindReplaceFunc, self).__init__()
#         self.text = text
#         self.key_binding_function()
#         self.binding_functiuons_configurations()
#
#     def binding_functiuons_configurations(self):
...
def FindAsk(parent,*args):
	root = Tkinter.Toplevel(parent)
	root.title("Find And Replace check still pending")
	print("checkl")
	print(root)
	print("rechec")
	root.transient(parent)
